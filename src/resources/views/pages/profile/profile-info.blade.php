                                    ...
                                    <div class="flex flex-col items-center w-full">
                                        ...
                                        <div class="p-profile__icons">
                                            <div class="col-span-2">
                                                <li class="d-dashboard__side-list">
                                                    <svg class="h-15 w-15 text-black-500" width="1.3em" height="1.7em"
                                            ...
                                            <div class="col-span-2 text-lg hover:scale-150"><a href="#"
                                                    aria-label="Go to Home page">Home</a></div>
                                            </li>
                                        </div>
                                        <div class="p-profile__icons">
                                            <div class="col-span-2">
                                            ...
                                            <div class="col-span-2 text-lg hover:scale-150"><a href="#"
                                                    aria-label="Go to Profile page">Profile</a></div>
                                            </li>
                                        </div>
                                        <div class="p-profile__icons">
                                            <div class="col-span-2">
                                                <li class="d-dashboard__side-list">
                                                    <svg class="h-6 w-6 text-black-500" fill="none" viewBox="0 0 24 24"
                                                        stroke="currentColor">
                                            ...
                                            <div class="col-span-2 text-lg hover:scale-150"><a href="#"
                                                    aria-label="Go to Friends page">Friends</a></div>
                                            </li>
                                        </div>
                                        <div class="p-profile__icons">
                                            <div class="col-span-2">
                                                <li class="d-dashboard__side-list">
                                                    <svg class="h-6 w-6 text-black-500" width="24" height="24"
                                        ...
                                        <div class="p-profile__icons">
                                            ...
                                            <div class="p-profile__logout"><a href="{{ route('logout') }}"
                                                    aria-label="Logout Account">Logout</a></div>
                                            </li>
                                        </div>
                                </ul>
                            </aside>
                            ...
                            <aside class="p-profile__aside">
                                <ul class="d-dashboard__side-nav">
                                    ...
                                    <div class="p-profile__icons">
                                        ...
                                        <div class="col-span-2 text-lg hover:scale-150"><a href="#"
                                                aria-label="Go to Profile page">Profile</a>
                                        </div>
                                        </li>
                                    </div>
                                    <div class="p-profile__icons">
                                        ...
                                        <div class="col-span-2 text-lg hover:scale-150"><a href="#"
                                                aria-label="Go to Friends page">Friends</a>
                                        </div>
                                        </li>
                                    </div>
                                    <div class="p-profile__icons">
                                        ...
                                        <div class="row-span-1">
                                            <div class="p-profile__small"> <!-- Reduced size -->
                                                <img class="object-cover w-full h-full"
                                                    src='{{ auth()->user()->profile->getImageURL() }}'
                                                    alt='Profile Picture'>
                                            </div>
                                        </div>
                                        <div class="grid gap-1">
