...
<body>
  <form action="/post" method="POST"> 
    ...
    <div class="d-dashboard__create-post">
      <div class="text-lg font-semibold">Share your mind with us</div>
      <div class="mt-2 mb-5">
        <input type="text" id="large-input" class="d-dashboard__write-post">
      </div>
      <div class="flex justify-between items-center">
        ...
        <button type="button" class="d-dashboard__post-btn">Share</button>
      </div>
    </div>
  </form>
</body>
